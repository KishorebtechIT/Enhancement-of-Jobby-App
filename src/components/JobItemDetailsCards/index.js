...
class JobItemDetailsCards extends Component {
  ...
  getJobItemDetails = async () => {
    ...
    const {searchInput, checkedBoxes, salaryFilter, checkedBoxes2} = this.state
    const employmentType = checkedBoxes.join()
    const locations = checkedBoxes2.join()
    const options = {
      headers: {
    ...
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employmentType}&location=${locations}&minimum_package=${salaryFilter}&search=${searchInput}`
    console.log(apiUrl)
  ...
  updateCheckboxes2 = id => {
    this.setState(
      prev => ({
        checkedBoxes2: [...prev.checkedBoxes2, id],
      }),
      this.getJobItemDetails,
    )
  }
      ...
      <div className="job-card">
        <div className="side-bar">
          ...
          <FilterGroup
            ...
            selectedCheckBox2={this.updateCheckboxes2}
